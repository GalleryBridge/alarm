...
MQTT_TOPIC = "alarm/fire/test"  # 替换为实际订阅的主题
...
# 测试
test_ws_url = "ws://110.42.214.129:8888/websocket/fireAlarm/fire_alarm"  # WebSocket URL
# 生产
...
# 用于存储最近检测到的目标及其时间戳
detection_cache = {}
CACHE_EXPIRATION_TIME = 60  # 60秒缓存时间
